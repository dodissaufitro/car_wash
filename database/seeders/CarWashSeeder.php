...
class CarWashSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('services')->insert([
            ['id' => 1, 'nama_service' => 'Cuci Motor', 'harga' => 15000, 'deskripsi' => 'Cuci motor biasa', 'created_at' => now()],
            ['id' => 2, 'nama_service' => 'Cuci Mobil', 'harga' => 40000, 'deskripsi' => 'Cuci mobil biasa', 'created_at' => now()],
            ['id' => 3, 'nama_service' => 'Cuci + Wax', 'harga' => 80000, 'deskripsi' => 'Cuci dan waxing', 'created_at' => now()],
            ['id' => 4, 'nama_service' => 'Salon Mobil', 'harga' => 150000, 'deskripsi' => 'Salon lengkap', 'created_at' => now()],
        ]);
